    ...
    <>
      <section className="bg-gradient-to-b from-surface-50 to-white">
        <Container className="py-20 text-center">
          <p className="font-mono text-xs uppercase tracking-wider text-accent-600">Insights</p>
  ...
  return (
    ...
    >
      <div className="grid gap-0 lg:grid-cols-2">
        <div className="hidden bg-surface-900 lg:flex lg:flex-col lg:justify-between lg:p-10">
        ...
        <div className="p-8 lg:p-10">
          ...
          <span className="mt-6 inline-flex items-center gap-1 text-sm font-medium text-surface-900 group-hover:text-accent-600">
...
function PostCard({ post }: { post: BlogPost }) {
  return (
    <Link
      to={`/blog/${post.slug}`}
      className="group flex flex-col rounded-2xl border border-surface-200 bg-white p-7 shadow-card transition-shadow hover:shadow-card-lg"
    >
      ...
      <h3 className="mt-4 font-display text-lg font-semibold leading-snug text-surface-900">
        {post.title}
      </h3>
